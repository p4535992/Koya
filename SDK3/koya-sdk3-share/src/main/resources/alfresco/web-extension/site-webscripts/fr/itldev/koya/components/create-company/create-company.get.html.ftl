...
<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/koya-share/components/create-company/create-company.css" group="console"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/components/console/consoletool.js" group="console"/>
   <@script src="${url.context}/res/koya-share/components/create-company/create-company.js" group="console"/>
</@>
